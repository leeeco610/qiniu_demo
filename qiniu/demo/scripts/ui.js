...
FileProgress.prototype.setChunkProgess = function(chunk_size) {
    ...
    if(!this.fileProgressWrapper.find('td').eq(2).find('.btn-default').length){
...
FileProgress.prototype.setError = function() {
    ...
    this.fileProgressWrapper.find('td').eq(2).find('.progress').css('width', 0).hide();
...
FileProgress.prototype.setCancelled = function(manual) {
    ...
    this.fileProgressWrapper.find('td').eq(2).find('.btn-default').hide();
    this.fileProgressWrapper.find('td').eq(2).find('.progressCancel').hide();
};
...
FileProgress.prototype.bindUploadCancel = function(up) {
    var self = this;
    if (up) {
        self.fileProgressWrapper.find('td').eq(2).find('.progressCancel').on('click', function(){
